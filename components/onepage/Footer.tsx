        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="mt-4 flex items-center gap-3">
              <a
                href="https://www.tiktok.com/@charityforchildrensmin?_r=1&_t=ZS-93ayX3LiBTE"
                target="_blank"
              ...
              <a
                href="https://youtube.com/@charityforchildrensministry?si=QhgB86OkGZ_LJvxU"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/85 transition-colors hover:text-white"
                aria-label="YouTube"
              ...
              <a
                href="https://www.instagram.com/charityforchildrensministry?igsh=MTl4Z3R0MnJwZW5uNA%3D%3D&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/85 transition-colors hover:text-white"
              ...
              <a
                href="https://www.facebook.com/share/1KobmdyYWc/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/85 transition-colors hover:text-white"
                aria-label="Facebook"
